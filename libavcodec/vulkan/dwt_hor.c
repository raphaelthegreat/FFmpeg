...
"        }\n"
"        // Lifting stage 2\n"
"        if (coord.x > 0 && coord.x < work_area.x - 1 && (((coord.x - 1) & 1) == 0)) {\n"
"            int a = dst_buf[plane_idx].coef_buf[start + coord.x];\n"
"            int b = dst_buf[plane_idx].coef_buf[start + coord.x - 1];\n"
"            int c = dst_buf[plane_idx].coef_buf[start + coord.x + 1];\n"
"            a -= (b + c + 1) >> 1;\n"
"            dst_buf[plane_idx].coef_buf[start + coord.x] = a;\n"
"        } else if (coord.x == work_area.x - 1) {\n"
...
"        } else if (coord.x < work_area.x - 2 && ((coord.x & 1) == 0)) {\n"
"            int a = dst_buf[plane_idx].coef_buf[start + coord.x];\n"
"            int b = dst_buf[plane_idx].coef_buf[start + coord.x - 1];\n"
"            int c = dst_buf[plane_idx].coef_buf[start + coord.x + 1];\n"
"            a += (b + c + 2) >> 2;\n"
"            dst_buf[plane_idx].coef_buf[start + 2 * coord.x] = a;\n"
"        } else if (coord.x == work_area.x - 2) {\n"
