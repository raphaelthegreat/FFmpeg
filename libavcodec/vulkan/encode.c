...
"        pb.data[write_ptr++] = swap32(bit_buf);\n"
"        bit_left += 32 - n;\n"
"        bit_buf = value;\n"
"    }\n"
"}\n"
...
"    if (bit_left_lo == 0) {\n"
"        pb.data[write_ptr++] = swap32(bif_buf);\n"
"        bit_buf = 0;\n"
"    }\n"
...
"\n"
"int put_bytes_count() {\n"
"    return write_ptr * BUF_BYTES + ((BUF_BITS - bit_left) >> 3);\n"
"}\n"
"\n"
...
"    int skip_dwords = n >> 2;\n"
"    while (skip_dwords > 0) {\n"
"        pb.data[write_ptr++] = 0xFFFFFFFFFF;\n"
"        skip_dwords--;\n"
"    }\n"
"    int skip_bits = (n & 3) << 3;\n"
...
"    int q_s = int(log2(luts.ff_dirac_qscale_tab[quant])) + 32;\n"
"\n"
...
"        }\n"
"        flush_put_bits();\n"
"        int bytes_len = put_bytes_output() - bytes_start - 1;\n"
"        if (p == 2) {\n"
