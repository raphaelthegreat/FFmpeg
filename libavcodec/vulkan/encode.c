...
"    if (slice_index == 0) {\n"
"        debugPrintfEXT(\"bit_buf 0x%x bit_left %d\\\\n\", bit_buf, bit_left);\n"
"    }\n"
"\n"
...
"            pad_c = (pad_s*size_scaler) - bytes_len;\n"
"        }\n"
"        pb.data[write_ptr_start] |= (pad_s & 0xFF) << (BUF_BITS - bit_left_start);\n"
"        /* vc2-reference uses that padding that decodes to '0' coeffs */\n"
"        skip_put_bytes(pad_c);\n"
"    }\n"
"\n"
"    //debugPrintfEXT(\"(%d, %d) wrote %d bytes (bit_left %d) from %d to %d dwords\\\\n\", slice_coord.x, slice_coord.y,\n"
"    //               (write_ptr - write_start) * 4, bit_left, write_start, write_ptr);\n"
"\n"
