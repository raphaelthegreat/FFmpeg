...
"    int coef_buf[];\n"
"};\n"
"layout(std430, buffer_reference, buffer_reference_align = 4) buffer BitBuf {\n"
"    uint data[];\n"
"};\n"
...
"        }\n"
"        if (bytes_len != 64) {\n"
"            debugPrintfEXT(\"Start %d Current %d PadC %d bytes_len %d \", write_start, write_ptr, pad_c, bytes_len);\n"
"        }\n"
